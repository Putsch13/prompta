...
export const PLANS: Record<PlanId, PromptaPlan> = {
  free: {
    ...
    tagline: "Construis et publie ton premier agent — gratuitement.",
    features: [
      "1 agent publié",
  ...
  pro: {
    ...
    tagline: "Pour les créateurs qui vivent de leurs agents.",
    highlight: true,
    features: [
      "20 agents publiés",
      "30 € de crédits IA inclus / mois",
      "Vends tes agents sur la marketplace (abonnements)",
