    ...
    actions: [
      {
        ...
        inputs: [
          ...
          { key: "range", label: "Plage (ex: Sheet1!A1:D10)", required: true, kind: "static" },
        ],
      },
      {
        id: "sheets.append",
        ...
        inputs: [
          ...
          { key: "range", label: "Plage", required: true, kind: "static" },
    ...
    actions: [
      {
        ...
        inputs: [
          ...
          { key: "text", label: "Message", type: "textarea", required: true, kind: "input", defaultScope: "dynamic" },
        ],
      },
    ],
  },
